...
pub mod apirequest_string;
pub mod apirequest_typed;
pub mod apistatus_string;
pub mod apistatus_typed;
...
pub mod framedisplay_string;
pub mod framedisplay_typed;
pub mod framevalues_string;
pub mod framevalues_typed;
pub mod idvalue_string;
pub mod idvalue_typed;
pub mod inputcontrolvalues_string;
pub mod inputcontrolvalues_typed;
pub mod itempriceinput_string;
pub mod itempriceinput_typed;
pub mod match__string;
pub mod match__typed;
pub mod newpost_string;
pub mod newpost_typed;
pub mod orderitem_string;
pub mod orderitem_typed;
pub mod patchtitle_string;
pub mod patchtitle_typed;
pub mod post_string;
pub mod post_typed;
pub mod replacepost_string;
pub mod replacepost_typed;
...
pub use apirequest_string::*;
pub use apirequest_typed::*;
pub use apistatus_string::*;
pub use apistatus_typed::*;
...
pub use framedisplay_string::*;
pub use framedisplay_typed::*;
pub use framevalues_string::*;
pub use framevalues_typed::*;
pub use idvalue_string::*;
pub use idvalue_typed::*;
pub use inputcontrolvalues_string::*;
pub use inputcontrolvalues_typed::*;
pub use itempriceinput_string::*;
pub use itempriceinput_typed::*;
pub use match__string::*;
pub use match__typed::*;
pub use newpost_string::*;
pub use newpost_typed::*;
pub use orderitem_string::*;
pub use orderitem_typed::*;
pub use patchtitle_string::*;
pub use patchtitle_typed::*;
pub use post_string::*;
pub use post_typed::*;
pub use replacepost_string::*;
pub use replacepost_typed::*;
