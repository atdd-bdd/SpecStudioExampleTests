...
def test_Scenario_AddItems():
    ...
    object_list_7 = [
        ItemPriceInputString('$80'),
    ]
    glue.then_total_of_items_is(object_list_7)
...
def test_Scenario_AShoppingCartWithAddresses():
    ...
    glue.given_catalog_has(object_list_8)
    ...
    glue.given_shopping_cart(object_list_9)
...
def test_Scenario_AddItemsToShoppingCart():
    ...
    glue.given_catalog_has(object_list_10)

    object_list_11 = [
        ShoppingCartString('=EmptyCart', '$0', '$0', '$0', AddressString('', '', '', ''), AddressString('', '', '', '')),
    ]
    glue.given_shopping_cart(object_list_11)
    ...
    glue.when_item_added(object_list_13)

    object_list_14 = [
        ShoppingCartString('=TwoItemCart', '$5', '$4', '$81', AddressString('', '', '', ''), AddressString('', '', '', '')),
    ]
    glue.then_shopping_cart_is(object_list_14)
...
def test_Scenario_CostOfEmptyOrderItemCollection():
    ...
    glue.given_catalog_has(object_list_15)

    object_list_16 = [
    ]
    glue.given_item_collection(object_list_16)

    object_list_17 = [
        ItemPriceInputString('$0'),
    ]
    glue.then_total_of_items_is(object_list_17)


# --- BusinessRule Tests ---

def test_BusinessRule_TotalCartPrice():
    glue = ShoppingCartGlue()
    object_list_18 = [
        CartInputString('$110', '$5', '$11', '$104', 'Discount applied before shipping calculated'),
        CartInputString('$80', '$5', '$4', '$81', ''),
    ]
    glue.examples_BusinessRule_TotalCartPrice(object_list_18)

def test_BusinessRule_ShippingCost():
    glue = ShoppingCartGlue()
    object_list_19 = [
        ShippingInputString('$99.99', '$5.00', 'Less than $100'),
        ShippingInputString('$100.00', '$0', 'Free if $100 or more'),
    ]
    glue.examples_BusinessRule_ShippingCost(object_list_19)

def test_BusinessRule_Discount():
    glue = ShoppingCartGlue()
    object_list_20 = [
        DiscountInputString('$24.99', '0', ''),
        DiscountInputString('$25.00', '5', ''),
        DiscountInputString('$99.99', '5', ''),
        DiscountInputString('$100.00', '10', ''),
    ]
    glue.examples_BusinessRule_Discount(object_list_20)
...
def test_DataType_Percentage():
    ...
    glue.examples_DataType_Percentage(object_list_21)
