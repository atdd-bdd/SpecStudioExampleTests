...
func TestRecordFilterExample_Scenario_FilterDataByID(t *testing.T) {
...
func TestRecordFilterExample_Scenario_FilterDataAnotherWay(t *testing.T) {
	glue := NewRecordFilterExampleGlue()
...
func TestRecordFilterExample_Scenario_AddAnotherValue(t *testing.T) {
	glue := NewRecordFilterExampleGlue()
...
func TestRecordFilterExample_Calculation_ConvertFToC(t *testing.T) {
	glue := NewRecordFilterExampleGlue()
...
func TestRecordFilterExample_DataType_IDForm(t *testing.T) {
	glue := NewRecordFilterExampleGlue()
