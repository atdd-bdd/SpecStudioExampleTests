import { MatchString, MatchTyped, RequestString, ResponseTyped, StatusString, StatusTyped }
...
export class AddressCorrectionGlue {
  ...
  thenTheMatchedAddressesAre(values: readonly MatchString[]): void {
  ...
  thenThereAreNoMatchedAddresses(): void {
